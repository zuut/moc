...
get_filename_component(MOC_CMAKE_MODULES "${CMAKE_CURRENT_LIST_DIR}/../../cmake-modules" ABSOLUTE)
set(MOC_LIBRARY "${CMAKE_CURRENT_LIST_DIR}")

# allow the cmake-modules to be found
list(APPEND CMAKE_MODULE_PATH ${MOC_CMAKE_MODULES})

# include the MOC targets
include(${CMAKE_CURRENT_LIST_DIR}/moc-targets.cmake)
# We could use the cmake-module search path below but 
