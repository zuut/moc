...
typedef void (*ufSHMakeEmptyFnc)(void*);
...
#define ufStrHashimplement(TYPE)                                              \
    ...
    ufStrHash(TYPE)::~ufStrHash(TYPE)() {                                     \
        MakeEmpty();                                                          \
        ufSHDeconstruct((ufGenericStrHash *)this);                            \
    }                                                                         \
                                                                              \
    void ufStrHash(TYPE)::MakeEmpty() {                                       \
        ufSHMakeEmpty_((ufGenericStrHash *)this,                              \
                       &ufStrHashIter(TYPE)::MakeEmpty);                      \
    }                                                                         \
                                                                              \
    ...
    ufStrHashIter(TYPE)::~ufStrHashIter(TYPE)() {}                            \
                                                                              \
    void ufStrHashIter(TYPE)::MakeEmpty(void* iter) {                         \
        ufStrHashIter(TYPE)* lpIter = (ufStrHashIter(TYPE)*)iter;             \
...
UF_API(void) ufSHDeconstruct(ufGenericStrHash *tbl);
...
UF_API(void) ufSHMakeEmpty_(ufGenericStrHash *tbl, ufSHMakeEmptyFnc f);
