...
#define ufPtrimplement(TYPE)                                                   \
    ...
    ufPtr(TYPE)::~ufPtr(TYPE)() {                                              \
        ...
        ufCHECK_MEMORY                                                         \
                                                                               ...
                                                                               \
    void ufPtr(TYPE)::DeleteRealPtr(ufGenericPtr *d) { delete ((TYPE *)d); }

typedef void (*ufPtrDeleteFnc)(ufGenericPtr *);

UF_API(void)
ufPtrConstruct_(ufPtr(void) * lpSelf, unsigned uSize, ufPtrDeleteFnc lpfnDelFnc,
...
UF_API(void)
ufPtrAssignInt_(ufPtr(void) * lpSelf, unsigned uSize, ufPtrDeleteFnc lpfnDelFnc,
                int nZero);
UF_API(void)
ufPtrAssignPtr_(ufPtr(void) * lpSelf, unsigned uSize, ufPtrDeleteFnc lpfnDelFnc,
                const ufPtr(void) * lpOtherPtr);
UF_API(void)
...
inline void ufPtr(void)::SwapWith(ufPtr(void) & o) { ufPtrSwapWith_(this, &o); }
...
#define implementvoidptr()                                                     \
    ...
    ufPtr(void)::~ufPtr(void)() {                                              \
        ...
        ufCHECK_MEMORY                                                         \
                                                                               ...
                                                                               \
    void ufPtr(void)::DeleteRealPtr(ufGenericPtr *d) { delete ((void *)d); }
